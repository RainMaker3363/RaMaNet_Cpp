...
public:
	...
	bool ConnectTo(char* szlp, unsigned short usPort);
	...
	inline int GetRecvBufSize()
	{
		return m_nRecvBufSize;
	}

	inline int GetSendBufSize()
	{
		return m_nSendBufSize;
	}

	inline int GetRecvIoRefCount()
	{ 
		return m_dwRecvIoRefCount;
	}

	inline int GetSendIorefCount()
	{
		return m_dwSendIoRefCount;
	}

	inline int GetAcceptIoRefCount()
	{
		return m_dwAcceptIoRefCount;
	}

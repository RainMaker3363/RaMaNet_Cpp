...
struct sLogConfig
{
	...
	sLogConfig()
	{
		...
		s_dwFileMaxSize = 1024 * 50000;	// 50MB 기본으로 설정 최대 100MB까지 가능
	}
};
...
// 실제 사용자가 쓰는 함수
// 초기화 함수
bool NETLIB_API INIT_LOG(sLogConfig &LogCinfig);

//////////////////////////////////////////////////////////////////////////////////////
// 로그를 남길 함수
// 로고 메시지 쓰는 방법 : (에러나 정보가 발생한 함수 | 에러나 정보에 관한 내용)
// Ex) ciocpServer::Bindiocp() | bind(), Filed...
